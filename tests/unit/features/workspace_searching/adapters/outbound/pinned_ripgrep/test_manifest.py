...
def test_verified_pinned_ripgrep_executable_fails_closed_on_unsupported_platform(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(
        "fabrica.features.workspace_searching.adapters.outbound.pinned_ripgrep.manifest.platform.system",
        lambda: "Windows",
    )
    monkeypatch.setattr(
        "fabrica.features.workspace_searching.adapters.outbound.pinned_ripgrep.manifest.platform.machine",
        lambda: "AMD64",
    )
...
def test_verified_pinned_ripgrep_executable_rejects_checksum_mismatch(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "fabrica.features.workspace_searching.adapters.outbound.pinned_ripgrep.manifest._platform_key",
        lambda: "darwin-arm64",
    )
...
def test_verified_pinned_ripgrep_executable_rejects_an_unsupported_platform_artifact(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
